...
class Visualizer:
    ...
    def vis_rank_list(self, output, vis_label, num_vis=100, rank_sort="ascending", label_sort="ascending", max_rank=5,
        ...
        query_indices = np.argsort(self.all_ap)  # ascending : the order of AP is low to high
    ...
    def plot_distribution(pos, neg, name='model', fig=None):
        ...
        # pos_color = (1., 0.65, 0.15)  # mar-hazy_duke
        pos_color = (0.8, 0.32, 1.)  # mar-hazy_duke
        ...
        # neg_color = (0.2, 0.66, 1.)  # mar-hazy_duke
        neg_color = (0.78, 0.78, 0.)  # mar-hazy_duke
