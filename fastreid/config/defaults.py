...
# --------------------------------------------add parameters
_C.MODEL.PARAM = CN()
_C.MODEL.PARAM.KD_TEMP = 10.
_C.MODEL.PARAM.KD_PARAM = 1.
_C.MODEL.PARAM.KD_red = 'mean'
_C.MODEL.PARAM.BD_param = 1.
_C.MODEL.PARAM.METRIC = "euclidean"
_C.MODEL.PARAM.Dis_net = "cam_Classifier"
_C.MODEL.PARAM.Dis_mode = "mix"
_C.MODEL.PARAM.Dis_iter = 0.8
_C.MODEL.PARAM.BASEMODE = False


# Path to a checkpoint file to be loaded to the model. You can find available models in the model zoo.
# _C.MODEL.WEIGHTS = "/home/pj/fast-reid-master/logs/hazy-dukemtmc/bagtricks_R50/CE_adv_baseline.pth"
_C.MODEL.WEIGHTS = ''
...
# target_Dataset
_C.TDATASETS = CN()
_C.TDATASETS.NAMES = ("Hazy_Market1501",)
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
# D_net parameters
_C.SOLVER.D_BASE_LR = 0.0003
_C.SOLVER.D_OPT = "Adam"
_C.SOLVER.D_STEPS = [60]
_C.SOLVER.D_GAMMA = 0.1
