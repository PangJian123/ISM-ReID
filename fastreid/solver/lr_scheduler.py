...
__all__ = ["WarmupMultiStepLR", "WarmupCosineAnnealingLR", "Net_scheduler"]
...
def Net_scheduler(optimizer, args, iterations=-1): # args.step_size, args.gamma,  args.lr_policy
    if args.SOLVER.LR_POLICY=='step':
        scheduler = lr_scheduler.StepLR(optimizer, step_size=args.SOLVER.D_STEPS,
                                        gamma=1, last_epoch=iterations)
    elif args.SOLVER.LR_POLICY=='multistep':
        step = args.SOLVER.D_STEPS
