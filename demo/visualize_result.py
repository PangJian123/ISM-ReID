...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        metavar="FILE",
        default='/home/pj/fast-reid-master/configs/Hazy_Market1501/load_bagtricks_R50.yml',
...
# python demo/visualize_result.py --output ./baseline_market_hazy_duke --opts MODEL.WEIGHTS '/home/pj/fast-reid-master/logs/hazy-market1501/bagtricks_R50/baseline/model_final.pth'
# python demo/visualize_result.py --output ./ISM_market_hazy_duke --opts MODEL.WEIGHTS '/home/pj/fast-reid-master/logs/hazy-market1501/bagtricks_R50/ISM/model_final.pth'